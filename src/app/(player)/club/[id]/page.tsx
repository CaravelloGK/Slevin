...
export default async function ClubTournamentPage({ params }: Props) {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: '#0d1117' }}>
      <AppHeader role={role} />
      <main
        className="flex-1 p-6 max-w-3xl mx-auto w-full"
        ...
        {startedAt && (
          <section className="mb-8">
            ...
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
              ...
              <StatCard
                label="Чистое игровое"
                value={totalMs > 0 ? formatDuration(netMs) : '—'}
                hint="без пауз"
              />
            </div>
          </section>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr style={{ background: '#0d1117', borderBottom: '1px solid #30363d' }}>
                    <th className="px-4 py-2.5 text-left text-[10px] tracking-[0.2em] text-[#484f58] uppercase font-semibold">
                      Место
                    </th>
                    <th className="px-4 py-2.5 text-left text-[10px] tracking-[0.2em] text-[#484f58] uppercase font-semibold">
                      Игрок
                    </th>
                    <th className="px-4 py-2.5 text-right text-[10px] tracking-[0.2em] text-[#484f58] uppercase font-semibold">
                      Доля
                    </th>
                    <th className="px-4 py-2.5 text-right text-[10px] tracking-[0.2em] text-[#484f58] uppercase font-semibold">
                      Приз
                    ...
                    return (
                      ...
                      >
                        ...
                        <td
                          ...
                          style={{ color: isTopPlace ? '#d4af37' : '#e6edf3' }}
                        >
                          {name}
                        </td>
                        <td
                        ...
                        <td
                          ...
                          style={{
                            color: isTopPlace ? '#d4af37' : '#e6edf3',
                            fontFamily: 'var(--font-space-mono)',
                          }}
                        >
                  ...
                  return (
                    ...
                    >
                      ...
                      <td
                        className="px-4 py-3 text-right text-sm"
                        style={{
                          color: p.rebuy_count > 0 ? '#d29922' : '#484f58',
                          fontFamily: 'var(--font-space-mono)',
                        }}
                      >
