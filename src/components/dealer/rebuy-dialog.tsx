          ...
          >
            ...
            <div className="flex items-center justify-center gap-4">
              <div className="text-center">
                ...
                >
                  {player.current_bounty.toLocaleString()}<span style={{ fontSize: '0.65em' }}> ₽</span>
                </div>
              </div>
              ...
              <div className="text-center">
                ...
                <div
                  ...
                  style={{ fontFamily: 'var(--font-space-mono)' }}
                >
                  {newCurrentBounty.toLocaleString()}<span style={{ fontSize: '0.65em' }}> ₽</span>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              style={{ fontFamily: 'var(--font-barlow)' }}
            >
              Зафиксировано {player.guaranteed_bounty.toLocaleString()}<span style={{ fontSize: '0.8em' }}> ₽</span> — без изменений
            </div>
          </div>
