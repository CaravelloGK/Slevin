-- Migration: fix process_knockout broken by 20260313000003
-- That migration used stale column names (is_active, finish_position).
-- Correct names: status ('active'/'eliminated'), final_position, eliminated_at.
